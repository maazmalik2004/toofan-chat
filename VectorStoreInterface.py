...
class VectorStoreInterface:
    def __init__(self,embedder_model = "models/embedding-001" ,db_url = "mongodb+srv://maazmalik2004:abenzene1234@dspace.odk45.mongodb.net/?retryWrites=true&w=majority&appName=Dspace"):
...
collection = vsi.get_collection("db","col")

# vector_store = vsi.create_vector_store(collection, "vector_store")

vector_store = vsi.get_vector_store(collection, "in")
